...
Actualmente en formación inicial en IES Sotero Hernández. Mi objetivo es desarrollar una base técnica sólida centrada en las buenas prácticas de programación y la arquitectura de datos.
...
Busco integrarme en un equipo profesional para iniciarme en las metodologías de trabajo reales del sector. Mi prioridad es aportar responsabilidad y compromiso mientras perfecciono mis capacidades técnicas bajo la guía de profesionales con experiencia.
